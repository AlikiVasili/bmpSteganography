 ...
 * @param const_char_*_newFileName The name of the new image file.
 */
PUBLIC void encodeStegano(const IMAGE *cover, const IMAGE *secret, unsigned short int bitNum, const char *newFileName);